...
local function setup(configs)
   ...
   return {
      ...
      markdownLatexBlock = { fg = colors.orange, bold = true, },
      markdownQuoteRegion = { fg = colors.yellow, italic = true, },
      markdownFootnote = { fg = colors.pink, },
      markdownFootnoteDefinition = { fg = colors.pink, },
