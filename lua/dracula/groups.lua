...
local function setup(configs)
   ...
   return {
      ...
      markdownBoldItalic = { fg = colors.red, bold = true, italic = true, },
      markdownStrike = { fg = colors.cyan, strikethrough = true, },
      markdownCode = { fg = colors.green, italic = true, },
      markdownCodeBlock = { fg = colors.green, },
      markdownCodeDelimiter = { fg = colors.purple, italic = true, },
      markdownH1 = { fg = colors.pink, bold = true, },
      markdownH2 = { fg = colors.cyan, bold = true, },
      ...
      markdownHeadingDelimiter = { fg = colors.comment, },
      ...
      markdownLinkDelimiter = { fg = colors.comment, },
      markdownLinkTextDelimiter = { fg = colors.comment, },
      markdownLinkText = { fg = colors.pink, },
      markdownLink = { fg = colors.purple, underline = true, },
      markdownUrl = { fg = colors.purple, underline = true, },
      markdownListMarker = { fg = colors.red, bold = true, },
      markdownOrderedListMarker = { fg = colors.cyan, bold = true, },
      markdownRule = { fg = colors.red, bold = true, },
      markdownInlineRef = { fg = colors.pink, underdouble = true, },
      markdownRef = { fg = colors.cyan, bold = true, },
      markdownLatexInline = { fg = colors.cyan, },
      markdownLatexBlock = { fg = colors.orange, standout = true, bold = true, },
      markdownQuoteRegion = { fg = colors.yellow, standout = true, italic = true, },
      markdownFootnote = { fg = colors.cyan, },
      markdownFootnoteDefinition = { fg = colors.cyan, },
